...
Next, we will deploy the Web Frontend, Customers v1, Customers v2, and the corresponding VirtualServices and DestinationRule. Once we deploy everything, all traffic gets routed to the Customers v1.
...
Save the above YAML to customers-vs.yaml and update the VirtualService with kubectl apply -f customers-vs.yaml.
